...
public class BienTheService {
 ...
 BienThe bt = new BienThe(rs.getString(1), rs.getString(2), rs.getString(3), rs.getString(4), rs.getString(5), rs.getString(6), rs.getString(7), rs.getBigDecimal(8));                findsql.add(bt);
    ...
    public List<BienThe> findByID(String id, String mausac) {
        String sql = """
                     SELECT [MaBienThe]
                                                  ...
                                                  ,[GiaBan]
                                                  ,[SoLuongMay]
                                              FROM [dbo].[BienThe] WHERE MaBienThe LIKE ? OR MauSac LIKE ? ;
                     """;
        try (Connection con = DBConnect.getConnection(); PreparedStatement ps = con.prepareStatement(sql)) {
            ps.setObject(1, id);
 ...
 BienThe bt = new BienThe(rs.getString(1), rs.getString(2), rs.getString(3), rs.getString(4), rs.getString(5), rs.getString(6), rs.getString(7), rs.getBigDecimal(8));                findsql.add(bt);
    ...
    public List<BienThe> selectbyID(String ma) {
        String sql = """
    ...
    public static void main(String[] args) {
        List<BienThe> lists = new BienTheService().findByID("", "Đen");
