...
public class SanPhamService {
   ...
   public List<SanPham> findByID(String ma,String ten){
       String sql = """
                    SELECT [MaSanPham]
                                               ,[TenSanPham]
                                               ,[HeDieuHanh]
                                               ...
                                               ,[CanNang]
                                               ,[TonKho]
                                           FROM [dbo].[SanPham]  WHERE MaSanPham =  OR TenSanPham LIKE ?;
                    """;
       try(Connection con = DBConnect.getConnection(); PreparedStatement ps = con.prepareStatement(sql)) {
